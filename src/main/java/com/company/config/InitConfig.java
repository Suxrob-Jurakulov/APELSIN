...
//        return args -> {
//            Optional<ClientEntity> optional = profileRepository.findByUsername("uz_card_moder");
//            if (optional.isPresent()){
//                return;
//            }
//            String md5 = MD5Util.getMd5("123");
//
//            ClientEntity admin = new ClientEntity();
//            admin.setName("Admin");
...
//
//            ClientEntity moderator = new ClientEntity();
